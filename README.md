...
[![NPM version](https://img.shields.io/npm/v/hello-s.svg)](https://npmjs.org/package/hello-s)
...
```sh
npm install git+ssh://git@github.com:K-zhy/stainless_test.git
```

> [!NOTE]
> Once this package is [published to npm](https://app.stainlessapi.com/docs/guides/publish), this will become: `npm install hello-s`
...
To do the inverse, add `import "hello-s/shims/node"` (which does import polyfills).
This can also be useful if you are getting the wrong TypeScript types for `Response` ([more details](https://github.com/K-zhy/stainless_test/tree/main/src/_shims#readme)).
...
- Deno v1.28.0 or higher, using `import Petstore from "npm:hello-s"`.
- Bun 1.0 or later.
- Cloudflare Workers.
- Vercel Edge Runtime.
